  ...
  const handleSubmit = async (e) => {
    ...
    const { data, error: signUpError } = await supabase.auth.signUp({
      ...
      options: {
        ...
        // Where the confirmation link in the email lands. PKCE puts the
        // exchange code in ?code=, ahead of the #/route, so this is safe
        // to combine with HashRouter.
    ...
    // If email confirmation is switched off in the Supabase project, signUp
    // returns an active session immediately, no confirmation step needed.
    if (data.session) {
      navigate('/')
      return
    }
